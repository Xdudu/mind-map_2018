...
import { KEY_MAP } from '../helpers/key-master'
        ...
        return <div styleName="container">
            ...
            <div styleName="tool-grp-container">
                <div styleName="tool-grp"
                    ...
                    <ToolBtn {...KEY_MAP.copy} svgPath={ICON_PATH.copy}
                        handleClick={() => this.handleOptionsOnMap('copy')} />
                    <ToolBtn {...KEY_MAP.paste} svgPath={ICON_PATH.paste}
                        handleClick={() => this.handleOptionsOnMap('paste')} />
                    <ToolBtn {...KEY_MAP.cut} svgPath={ICON_PATH.cut}
                        handleClick={() => this.handleOptionsOnMap('cut')} />
                    <ToolBtn {...KEY_MAP.remove} svgPath={ICON_PATH.remove}
                        handleClick={() => this.handleOptionsOnMap('remove')} />

                    <div styleName="vertical-line" />

                    <ToolBtn {...KEY_MAP.numberChild} svgPath={ICON_PATH.numberChild}
                        handleClick={() => this.handleOptionsOnMap('numberChild')} />

                    <div styleName="vertical-line" />

                    <ToolBtn {...KEY_MAP.save} svgPath={ICON_PATH.save}
