        ...
        return <div styleName="container">
            ...
            <div styleName="tool-grp-container">
                <div styleName="tool-grp"
                    ...
                    <div styleName="btn" onClick={() => this.handleOptionsOnMap('copy')}>
                        <svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <path d={ICON_PATH.copy} />
                        </svg>
                    </div>
                    <div styleName="btn" onClick={() => this.handleOptionsOnMap('paste')}>
                        <svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <path d={ICON_PATH.paste} />
                        </svg>
                    </div>
                    <div styleName="btn" onClick={() => this.handleOptionsOnMap('cut')}>
                        <svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <path d={ICON_PATH.cut} />
                        </svg>
                    </div>
                    <div styleName="btn" onClick={() => this.handleOptionsOnMap('remove')}>
                        <svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <path d={ICON_PATH.remove} />
                        </svg>
                    </div>
